  ...
  return (
    <footer className="bg-gray-50 border-t border-gray-200 mt-20 pt-16 pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12 border-b border-gray-200 pb-12">
          {FOOTER_LINKS.map((column, idx) => (
            <div key={idx}>
              <h3 className="font-semibold text-xs tracking-wider text-gray-900 mb-4 uppercase">{column.title}</h3>
